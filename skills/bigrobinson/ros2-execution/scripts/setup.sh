#!/bin/bash
echo "Configuring ros2-execution skill..."
...
# AMENT_PREFIX_PATH contains a colon-separated list of all sourced workspaces
if [ -z "$AMENT_PREFIX_PATH" ]; then
    echo "Error: AMENT_PREFIX_PATH is empty. Make sure ROS 2 is sourced."
    exit 1
fi

# Convert colon-separated AMENT_PREFIX_PATH to a JSON array of strings
...
echo "  - WORKSPACE_ROOTS: [$JSON_ARRAY]"
