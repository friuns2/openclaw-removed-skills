...
version: "1.0.0"
displayName: "Bing Image Creator — Generate Images From Text Prompts"
description: >
  Turn a short text description like 'a fox reading a book in a forest at sunset' into 1080p AI generated visuals just by typing what you need. Whether it's generating images from text descriptions for creative projects or quick social content, drop your text prompts and describe the result you want. No timeline dragging, no export settings — 20-40 seconds from upload to download.
