---
name: add-subtitle-to-video-extension
version: "1.0.0"
displayName: "Add Subtitle to Video Extension — Generate and Embed Video Subtitles"
description: >
  Get captioned video files ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "add English subtitles to my video automatically", and download 1080p MP4 when it's done. Built for YouTubers who move fast and need captions added quickly without desktop software.
