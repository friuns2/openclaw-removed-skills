...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' <tool_name> [param:value ...]
```

To discover all available tools and their parameters:

```
mcporter list 'npx @xreplyai/mcp@0.3.17' --all-parameters
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate topic:"my SaaS hit 1000 users"
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate topic:"lessons from year 1" angle:story_arc
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate platform:linkedin topic:"leadership lessons"
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate angle:one_liner
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate topic:"entrepreneurship hardships" 'platforms:["twitter","linkedin","threads"]'
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate_batch category:personalized count:5
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate_batch category:trending count:3
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_list
```
...
**X-only post (simple):**
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create body:"Your tweet text here"
```

**X post with auto-retweet:**
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create post_contents:'[{"platform":"twitter","body":"Tweet text","metadata":{"auto_rt_hours":24}}]'
```

**LinkedIn post:**
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create post_contents:'[{"platform":"linkedin","body":"Your long LinkedIn post here..."}]'
```

**Cross-post to X and LinkedIn with different text:**
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create post_contents:'[{"platform":"twitter","body":"Short tweet"},{"platform":"linkedin","body":"Expanded LinkedIn version..."}]'
```

**X post with image (upload first with xreply_media_upload):**
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create post_contents:'[{"platform":"twitter","body":"Check this out","content_type":"single_image","metadata":{"media_id":"1234567890"}}]'
```

**LinkedIn post with image (upload first with xreply_media_upload):**
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create post_contents:'[{"platform":"linkedin","body":"Caption here","content_type":"single_image","metadata":{"asset_urn":"urn:li:digitalmediaAsset:..."}}]'
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_edit id:123 body:"Updated tweet text"
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_edit id:123 'scheduled_at:2026-03-15T09:00:00Z'
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_edit id:123 post_contents:'[{"platform":"linkedin","body":"Updated LinkedIn text"}]'
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_delete id:123
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_media_upload image_path:/path/to/photo.jpg platform:twitter
→ returns { platform: "twitter", media_id: "1234567890" }
```

**Upload an image for LinkedIn:**
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_media_upload image_path:/path/to/photo.png platform:linkedin
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_video_upload video_path:/path/to/video.mp4
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:123 account_id:1
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:123 account_id:1 'scheduled_at:2026-03-15T09:00:00Z'
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:123 'account_ids:[1,2]'
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_billing_status
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_voice_status
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_preferences_get
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_preferences_set tone:witty
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_preferences_set tone:professional include_emoji:false
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_preferences_set structure:story_arc
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_list_social_accounts
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_platform_styles_get
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_platform_styles_get platform:linkedin
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_platform_styles_set platform:linkedin tone:witty
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_platform_styles_set platform:threads hashtag_rules:none cta_rules:soft_question
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_platform_styles_set platform:linkedin custom_instructions:"always reference my bootstrapping journey"
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_rules_list
```
...
```
mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_list_twitter_communities
```
...
```
1. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate topic:"ship fast, learn faster" angle:story_arc
   → returns { body: "...", post: { id: 42, ... } }
2. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:42 account_id:1 'scheduled_at:2026-03-12T09:00:00Z'
```

### Generate and schedule a LinkedIn post

```
1. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate platform:linkedin topic:"leadership lessons from year 1" angle:story_arc
   → returns { body: "...", post: { id: 43, ... } }
2. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:43 account_id:2 'scheduled_at:2026-03-12T09:00:00Z'
```

### Cross-post to X and LinkedIn with different text

```
1. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate topic:"motivation" platform:twitter
   → { body: "Short tweet...", post: { id: 44 } }
2. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate topic:"motivation" platform:linkedin
   → { body: "Long LinkedIn article...", post: { id: 45 } }

   Or create as a single post with both platforms:
3. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create post_contents:'[{"platform":"x","body":"Short tweet..."},{"platform":"linkedin","body":"Long LinkedIn article..."}]'
4. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:46 'account_ids:[1,2]' 'scheduled_at:2026-03-13T09:00:00Z'
```

### Plan posts for the week

```
1. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_billing_status
   → check remaining quota before a large batch
2. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_generate_batch category:personalized count:7
   → generates 7 drafts
3. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_list
   → review the queue
4. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_edit id:101 'scheduled_at:2026-03-11T09:00:00Z'
   mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_edit id:102 'scheduled_at:2026-03-12T09:00:00Z'
   → schedule each post
```
...
```
1. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_list
   → find the draft ID
2. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_edit id:55 body:"Revised tweet text"
3. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:55 account_id:1
```

### Post an X image

```
1. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_media_upload image_path:/Users/me/photo.jpg platform:twitter
   → { media_id: "1234567890" }
2. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create post_contents:'[{"platform":"twitter","body":"Check this out!","content_type":"single_image","metadata":{"media_id":"1234567890"}}]'
   → { post: { id: 77, ... } }
3. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:77 account_id:1
```

### Post to an X community

```
1. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_list_twitter_communities
   → returns [{ community_id: "12345", name: "AI Builders", last_used_at: "..." }, ...]
2. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create post_contents:'[{"platform":"twitter","body":"Exciting update for the community!","metadata":{"community_id":"12345"}}]'
   → { post: { id: 88, ... } }
3. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:88 account_id:1
```
...
```
1. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_list_social_accounts
   → find your Threads account id (platform: "threads")
2. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create post_contents:'[{"platform":"threads","body":"Your Threads post here (max 500 chars)"}]'
   → { post: { id: 90, ... } }
3. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:90 account_id:3
```
...
```
1. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create post_contents:'[{"platform":"threads","body":"Check this out!","content_type":"single_image","metadata":{"image_url":"https://example.com/image.jpg"}}]'
   → { post: { id: 91, ... } }
2. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:91 account_id:3
```
...
```
1. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_media_upload image_path:/Users/me/banner.png platform:linkedin
   → { asset_urn: "urn:li:digitalmediaAsset:ABC123" }
2. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create post_contents:'[{"platform":"linkedin","body":"Excited to share this!","content_type":"single_image","metadata":{"asset_urn":"urn:li:digitalmediaAsset:ABC123"}}]'
   → { post: { id: 78, ... } }
3. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:78 account_id:2
```

### Post a LinkedIn video

```
1. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_video_upload video_path:/Users/me/demo.mp4
   → { platform: "linkedin", asset_urn: "urn:li:video:ABC123" }
2. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_create post_contents:'[{"platform":"linkedin","body":"Watch this demo!","content_type":"video","metadata":{"asset_urn":"urn:li:video:ABC123"}}]'
   → { post: { id: 79, ... } }
3. mcporter call 'npx @xreplyai/mcp@0.3.17' xreply_posts_publish id:79 account_id:2
```
