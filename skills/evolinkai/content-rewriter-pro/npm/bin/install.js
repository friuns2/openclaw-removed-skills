...
const SLUG = "content-rewriter-pro";
const VERSION = "1.0.0";
...
function main() {
  console.log(`\n  Content Rewriter — OpenClaw Skill Installer v${VERSION}`);
  ...
  console.log("  2. bash scripts/rewriter.sh rewrite mypost.txt --platform twitter");
  console.log("  3. bash scripts/rewriter.sh help");
  console.log("");
}
