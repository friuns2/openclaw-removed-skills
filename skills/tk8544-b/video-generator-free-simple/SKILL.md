---
name: video-generator-free-simple
version: "1.0.0"
displayName: "Video Generator Free Simple — Create and Export Videos Fast"
description: >
  generate text or images into ready-to-share videos with this skill. Works with MP4, JPG, PNG, MOV files up to 200MB. beginners and casual creators use it for generating short videos from text or images without editing software — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-generator-free-simple` |
