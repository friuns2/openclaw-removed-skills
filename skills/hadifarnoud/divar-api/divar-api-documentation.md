...
Categories are passed as `category.str.value` in `form_data`.

| Slug | Description (Persian) |
|------|-----------------------|
| `real-estate` | همه انواع ملک (all real estate) |
| `apartment-sell` | فروش آپارتمان (apartment sale) |
| `rent-apartment` | اجاره آپارتمان (apartment rental) |
| `buy-residential` | فروش مسکونی (residential sale) |
| `rent-residential` | اجاره مسکونی (residential rental) |
| `buy-commercial-property` | فروش اداری و تجاری (commercial sale) |
| `rent-commercial-property` | اجاره اداری و تجاری (commercial rental) |
| `rent-temporary` | اجاره کوتاه‌مدت (short-term rental) |
| `real-estate-services` | پروژه‌های ساخت‌وساز (construction) |
...
- **Auth**: Cookie-based session authentication; no Bearer token observed in request headers
