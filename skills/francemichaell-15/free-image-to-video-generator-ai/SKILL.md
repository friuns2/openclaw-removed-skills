---
name: free-image-to-video-generator-ai
version: "1.0.0"
displayName: "Free Image to Video Generator AI — Convert Images into Video Clips"
description: >
  convert still images into animated video clips with this skill. Works with JPG, PNG, WEBP, GIF files up to 200MB. social media creators use it for converting static images into shareable video content — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
# Free Image to Video Generator AI — Convert Images into Video Clips
...
User prompts referencing free image to video generator ai, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `free-image-to-video-generator-ai` |
